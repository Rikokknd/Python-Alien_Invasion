...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets: pygame.sprite.Group):
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    # check collisions, remove bullet and alien on collision
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    check_aliens_reach_bottom(ai_settings, stats, screen, sb, ship, aliens, bullets)
...
def check_aliens_reach_bottom(ai_settings, stats, screen, sb, ship, aliens, bullets):
